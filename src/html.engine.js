...
(this || (0, eval)('this'), function (window) {
    ...
    (function () {
        ...
        this.dropdown = function (list, current, displayField, valueField) {
            ...
            var ddl = this.each(list, function (model) {
                ...
                var isEqual = model === currentValue || valueField && currentValue && model[valueField] === currentValue[valueField];
                html.option(display, value, isEqual).$();
            }).$$();
            // if current value is null
            // set the selected index for the drop down to be -1
            if (isNoU(html.getData(current))) ddl.selectedIndex = -1;
