...
return c(e)?(n=m.uniqueId||++T,m.uniqueId=n,k[n]=k[n]||{},k[n][t]=e,void 0):(n=m.uniqueId,n&&k[n]?k[n][t]:null)},this.get=function(e,n){if(e&&(e.nodeType||e===t))m=e
...
var _=g.array(["Arguments","Function","String","Number","Date","RegExp"])
_.each(function(t){g["is"+t]=function(e){return a.toString.call(e)==="[object "+t+"]"}}),this.getData=function(t){for(var e=t;o(e);)e=e()
return e}
var T=1
...
var a=e.getAttribute("href"),s=e.getAttribute("ignore-route")
